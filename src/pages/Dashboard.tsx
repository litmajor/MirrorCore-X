...
const Dashboard: React.FC = () => {
  ...
  const MetricCard = ({ title, value, change, icon: Icon, trend }: any) => (
    <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">Real-time trading system overview</p>
        </div>
